...
- I learned that a dashboard should be created focusing on **three key aspects**:

  - 👀 **Visibility** → Can you see what is happening across your **endpoints, users, and email**?  
