...
---
If I want to run an Advanced hunting using KQL, there is an option "Go hunt" which allow me to see the tables and run queries.

<img width="1575" height="856" alt="image (2)" src="https://github.com/user-attachments/assets/f950d355-3610-437d-8341-8dfd87bf1436" />

---
Quarantine is where suspicious emails are held when they are flagged as threats, before reaching users. They are not immediately deleted.
...
---
When Bob reported the suspicious email, it was received in Investigation & response / Actions & submissions / submissions
